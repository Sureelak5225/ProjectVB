Public Class frmLab3
    ...
    Private Sub cobSize_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cobSize.SelectedIndexChanged
        txtInput.Font = New Font(txtInput.Font.Name, cobSize.SelectedItem, FontStyle.Regular)
    End Sub

    Private Sub lblUp_Click(sender As Object, e As EventArgs)
